...
generate_graphics v $transforms $dir/trajectory.txt
generate_graphics v $softtransforms $dir/softtrajectory.txt
...
#---------------- GENERATE GRAPHICS ------------------
gnuplot -e "file='${dir}velocity.png'; file0='${dir}trajectory.txt'; \
file1='${dir}softtrajectory.txt'" ${bindir}plgs/velocity.plg
...
file11='${dir}linear_scale_spacey.dft'; fps='$fps'" ${bindir}plgs/dft2.plg

#Generate zoom linear dft graphics
gnuplot -e "file='${dir}zoom_linear_dft.png'; \
file1='${dir}linear_scale_space_zoom.dft'; titulo='z'; fps='$fps'" ${bindir}plgs/dft.plg

#Generate rotation linear dft graphics
gnuplot -e "file='${dir}rotation_linear_dft.png'; \
file1='${dir}linear_scale_space_rotation.dft'; titulo='angle'; fps='$fps'" ${bindir}plgs/dft.plg
